            ...
            <div className='flex flex-col'>
                ...
                <div>
                    <div className='flex justify-end'>
                        ...
                        <button className='mr-2 my-1 uppercase tracking-wider px-2 text-red-500 border-red-500 hover:bg-red-500 hover:text-white border text-sm font-semibold rounded py-1 transition transform duration-500 cursor-pointer'>
                            Delete
                        </button>
                    </div>
                </div>
