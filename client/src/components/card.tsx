        ...
        <div className="flex flex-col">
          <div className="flex justify-between items-center w-50">
            <div className="text-lg font-semibold text-bookmark-blue flex space-x-1 items-center mb-2">
              ...
              <span>Dr. Leonard McCoy</span>
            </div>
            <span className="bg-green-600 rounded-full uppercase text-white text-sm px-4 py-1 font-bold shadow-xl"> 8/20/22, 2:00p </span>
          </div>
          <div className="text-sm text-gray-500 flex space-x-1 items-center">
            <span>Cardiologist</span>
          </div>
          <div className="text-sm text-gray-500 flex items-center">
            <span>Heart Institute of San Francisco</span>
          </div>
          <div>
