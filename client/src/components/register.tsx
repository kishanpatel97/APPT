...
const Register: React.FC = () => {
    ...
    useEffect(() => {
        if (!initialLoad) {
            ...
            passwordField.current?.setSelectionRange(
    ...
    const register = (e: FormEvent) => {
        ...
        axios
            .post<IUserReg>('http://localhost:8000/api/users/register', user)
            .then((res) => {
                setUser({
                    firstName: '',
                    lastName: '',
            ...
            <form onSubmit={register} onKeyUp={capsLockCheck} className='loginReg'>
                ...
                <div className={errors.email ? 'mt-3 mb-2' : 'mt-3 mb-5'}>
                    <input
                        ...
                        type='text'
                    />
                    {errors.email ? <p className='m-2 alertBad'>{errors.email.message}</p> : null}
                </div>
                ...
                <div className='relative'>
                    ...
                    <img
                        src='/capsArrow.png'
                        style={
                            capsCheck ? { display: 'inline', bottom: '20%' } : { display: 'none' }
                        }
                        alt='capsCheckImg'
                        className='capsCheck'
                    />
